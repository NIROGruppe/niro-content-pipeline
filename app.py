...
with col5:
    ...
    <div class="app-card">
        <div class="icon">🔍</div>
        <div class="title">Lead Scraper</div>
        <div class="desc">Kontaktdaten scrapen (Google Maps + Web), ClickUp-Abgleich und automatischer Import.</div>
    </div>
    """, unsafe_allow_html=True)
...
with col6:
    ...
    <div class="app-card">
        <div class="icon">📈</div>
        <div class="title">Stock Bot</div>
        <div class="desc">KI-gestützter Trading Bot mit Sentiment-Analyse, Underdog Scanner und Postmortem-Learning.</div>
    </div>
    """, unsafe_allow_html=True)
    if st.button("Stock Bot öffnen", use_container_width=True):
        st.switch_page("pages/5_test.py")
